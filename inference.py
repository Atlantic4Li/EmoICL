...
sys.path.insert(0, "/home/lixiyang/ICL/LLaVA-NeXT")
sys.path.insert(0, "/home/lixiyang/ICL/Qwen-VL")
...
def parse_args():
    ...
    parser.add_argument('--sim_path', default='/data0/lxy_data/Intentonomy/cross_similarity.pkl', type=str, help='the similarity of all images')
    parser.add_argument('--support_path', default='/data0/lxy_data/Intentonomy/support_features.pkl', type=str, help='the features of support images')
    parser.add_argument('--query_path', default='/data0/lxy_data/Intentonomy/query_features.pkl', type=str, help='the features of query images')
    ...
    parser.add_argument('--strategy', default='various', type=str, choices=['random', 'similarity', 'diverse', 'various'], help='Example selection strategy.')
...
def eval_questions(args, query_meta, support_meta, model, tokenizer, processor, engine, n_shot):
    ...
    with open(args.support_path, 'rb') as f:
    ...
    for query in tqdm(query_meta):
        ...
        n_shot_support = ICL_utils.select_demonstration(support_meta, n_shot, args.dataset, args.strategy, query, similarity_data, support_features, query_feature)
...
if __name__ == "__main__":
    ...
    for engine in args.engine:
        ...
        for shot in args.n_shot:
            ...
            os.makedirs(f"{args.resultDir}/{args.dataset}_{args.strategy}_{current_time_str}", exist_ok=True)
            with open(f"{args.resultDir}/{args.dataset}_{args.strategy}_{current_time_str}/{engine}_{shot}-shot.json", "w") as f:
